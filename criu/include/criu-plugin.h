...
enum {
	...
	CR_PLUGIN_HOOK__RESTORE_ASYNCHRONOUS = 12,
...
DECLARE_PLUGIN_HOOK_ARGS(CR_PLUGIN_HOOK__RESTORE_ASYNCHRONOUS, void);
...
typedef int(cr_plugin_restore_asynchronous_t)(void);
