...
enum {
	...
	CR_PLUGIN_HOOK__RESTORE_DEVICE_PARALLEL = 12,
...
DECLARE_PLUGIN_HOOK_ARGS(CR_PLUGIN_HOOK__RESTORE_DEVICE_PARALLEL, void);
...
typedef int(cr_plugin_restore_device_parallel_t)(void);
